...
use crate::declarations::functions::compile_parameters;
...
use crate::emit::analysis::collect_free_variables_in_expression;
use crate::emit::analysis::collect_free_variables_in_statements;
use crate::emit::analysis::collect_scoped_bindings_in_expression;
use crate::emit::capture_gate;
use crate::emit::collect_assigned_in_expression;
use crate::emit::line_and_column;
use crate::types::TypeScope;
use crate::types::descriptor_is_never;
use crate::types::lowering::lower_type;
use crate::types::lowering::validate_return_annotation;

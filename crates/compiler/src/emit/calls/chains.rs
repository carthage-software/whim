...
use crate::emit::calls::MethodCall;
use crate::emit::calls::NullSafeMethodCall;
use crate::emit::calls::NullSafePropertyAccess;
use crate::emit::calls::PropertyAccess;
use crate::emit::calls::Scope;
use crate::emit::calls::Span;
use crate::emit::calls::ValueUse;
use crate::emit::calls::argument_gate;
use crate::emit::calls::call_method_instruction;
use crate::emit::calls::call_value_instruction;
...
impl BodyCompiler<'_, '_> {
    ...
    /// single null result.
    pub(in crate::emit) fn chain_root(
        &mut self,
        scope: &Scope<'_>,
    ...
    pub(in crate::emit) fn chain_root_with_use(
        &mut self,
        scope: &Scope<'_>,
        expression: &Expression<'_>,
        value_use: ValueUse,

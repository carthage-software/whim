...
use crate::emit::calls::Argument;
use crate::emit::calls::ArgumentList;
use crate::emit::calls::BodyCompiler;
use crate::emit::calls::Call;
use crate::emit::calls::Callee;
use crate::emit::calls::CalleeSource;
use crate::emit::calls::ClassReference;
use crate::emit::calls::CompileError;
use crate::emit::calls::CompileErrorKind;
use crate::emit::calls::Expression;
use crate::emit::calls::HasSpan;
use crate::emit::calls::PartialApplication;
use crate::emit::calls::PartialArgument;
use crate::emit::calls::Scope;
use crate::emit::calls::Span;
use crate::emit::calls::ValueUse;
use crate::emit::calls::argument_gate;
use crate::emit::calls::call_with_names_instruction;
use crate::emit::calls::check_call_type_argument_arity;
use crate::emit::calls::check_named_arguments;
use crate::emit::calls::check_sequence;
...
impl BodyCompiler<'_, '_> {
    ...
    pub(in crate::emit::calls) fn callee_expression_value(
        &mut self,
        scope: &Scope<'_>,
    ...
    pub(in crate::emit::calls) fn materialize_callee(
        &mut self,
        scope: &Scope<'_>,
        callee: &Callee<'_>,
    ) -> Result<Register, CompileError> {
    ...
    pub(in crate::emit::calls) fn callee_value(
        &mut self,
        scope: &Scope<'_>,
    ...
    pub(in crate::emit::calls) fn shaped_call(
        &mut self,
        scope: &Scope<'_>,
        source: &CalleeSource<'_, '_>,
    ...
    pub(in crate::emit) fn partial_application(
        &mut self,
        scope: &Scope<'_>,
        application: &PartialApplication<'_>,
    ) -> Result<Register, CompileError> {
    ...
    pub(in crate::emit) fn instantiation(
        &mut self,
        scope: &Scope<'_>,
        instantiation: &Instantiation<'_>,
    ) -> Result<Register, CompileError> {

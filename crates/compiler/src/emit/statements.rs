...
use crate::emit::Cleanup;
use crate::emit::CompileError;
use crate::emit::CompileErrorKind;
use crate::emit::ControlFrame;
use crate::emit::Expression;
use crate::emit::HasSpan;
use crate::emit::LoopFrame;
use crate::emit::LoopJump;
use crate::emit::Scope;
use crate::emit::Span;
use crate::emit::Statement;
use crate::emit::UsingCleanup;
use crate::emit::UsingResource;
use crate::emit::UsingTarget;
use crate::emit::check_sequence;
use crate::emit::lower_checked_type;
use crate::emit::matching::check_bind_target;
use crate::emit::pop_finally_holes;
use crate::emit::pop_loop_frame;
use crate::emit::scan_statements;
use crate::emit::subtract_holes;
...
impl<'arena> BodyCompiler<'_, 'arena> {
    pub(in crate::emit) fn statement<'source>(
        &mut self,
        scope: &Scope<'_>,
    ...
    pub(in crate::emit) fn emit_return(
        &mut self,
        scope: &Scope<'_>,
    ...
    pub(in crate::emit) fn loop_jump(
        &mut self,
        scope: &Scope<'_>,
        level: u64,
        kind: LoopJump,
    ...
    pub(in crate::emit) fn if_statement<'source>(
        &mut self,
        scope: &Scope<'_>,
    ...
    pub(in crate::emit) fn using_statement<'source>(
        &mut self,
        scope: &Scope<'_>,
    ...
    pub(in crate::emit) fn try_statement<'source>(
        &mut self,
        scope: &Scope<'_>,

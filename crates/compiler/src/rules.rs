...
pub(crate) fn check_class(class: &Class<'_>) -> Result<(), CompileError> {
...
pub(crate) fn check_interface(interface: &Interface<'_>) -> Result<(), CompileError> {
    check_members(interface.members, DeclarationKind::Interface)
}

pub(crate) fn check_enum(declaration: &Enum<'_>) -> Result<(), CompileError> {
...
pub(crate) fn promoted_properties<'arena>(
    method: &Method<'arena>,
...
pub(crate) fn check_free_function_parameters(
    parameter_list: &ParameterList<'_>,
) -> Result<(), CompileError> {
    for parameter in &parameter_list.parameters {
        if let Some(modifier) = parameter.modifiers.first() {
...
pub(crate) fn check_constant_expression(expression: &Expression<'_>) -> Result<(), CompileError> {
    check_constant_expression_at(expression, ConstantExpressionPosition::AttributeArgument)
}

pub(crate) fn check_parameter_default(expression: &Expression<'_>) -> Result<(), CompileError> {
    check_constant_expression_at(expression, ConstantExpressionPosition::ParameterDefault)
}

pub(crate) fn check_constant_initializer(expression: &Expression<'_>) -> Result<(), CompileError> {
    check_constant_expression_at(expression, ConstantExpressionPosition::ConstantInitializer)
}

pub(crate) fn check_property_default(expression: &Expression<'_>) -> Result<(), CompileError> {

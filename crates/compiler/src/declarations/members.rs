...
use whim_bytecode::unit::CompiledClassConstant;
use whim_bytecode::unit::CompiledClassLike;
use whim_bytecode::unit::CompiledEnumCase;
...
pub(in crate::declarations) fn compile_members(
    scope: &Scope<'_>,

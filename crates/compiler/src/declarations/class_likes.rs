...
use crate::declarations::members::compile_members;
...
pub(crate) fn validate_variance_use(
...
pub(in crate::declarations) fn compile_class<'arena>(
    array: &Array<'_, 'arena>,
    resolver: &Resolver,
    class: &Class<'arena>,
...
pub(in crate::declarations) fn compile_interface<'arena>(
    array: &Array<'_, 'arena>,
    resolver: &Resolver,
...
pub(in crate::declarations) fn compile_enum<'arena>(
    array: &Array<'_, 'arena>,
    resolver: &Resolver,

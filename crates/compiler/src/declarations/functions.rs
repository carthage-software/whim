...
impl<'compilation> DeclarationContext<'compilation> {
    pub(crate) fn for_unit(unit: &'compilation mut CompiledUnit) -> Self {
        Self {
...
pub(in crate::declarations) fn compile_function_declaration(
    heap: &Heap,
    scope: &Scope<'_>,
    function: &Function<'_>,
    path: &str,
...
pub(in crate::declarations) fn compile_body(
    scope: &Scope<'_>,
    path: &str,
    source_text: &str,
    unit: &mut CompiledUnit,
...
pub(in crate::declarations) fn inert_declaration_chunk(span: Span) -> Chunk {
...
pub(crate) fn compile_attributes(
    heap: &Heap,
    scope: &Scope<'_>,
    attribute_lists: &[AttributeList<'_>],
    path: &str,

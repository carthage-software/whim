...
use crate::Target;
use crate::declarations::class_likes::compile_class;
use crate::declarations::class_likes::compile_enum;
use crate::declarations::class_likes::compile_interface;
use crate::declarations::class_likes::validate_variance_use;
use crate::declarations::functions::DeclarationContext;
use crate::declarations::functions::compile_attribute;
use crate::declarations::functions::compile_attributes;
use crate::declarations::functions::compile_function_declaration;
use crate::declarations::functions::compile_initializer;
use crate::declarations::functions::has_attribute;
...
use crate::types::aliases::collect_alias_references;
use crate::types::aliases::find_alias_cycle;
use crate::types::lowering::lower_type;
use crate::types::rendering::render_type;

pub(crate) mod class_likes;
pub(crate) mod functions;
pub(crate) mod generics;
mod members;
pub(crate) mod sealed;

pub(crate) struct Region<'source, 'arena> {
    pub(crate) resolver: Resolver,
    pub(crate) declared_names: HashSet<String>,
    pub(crate) main_statements: Vec<(&'source Statement<'arena>, Resolver)>,
    pub(crate) file_attributes: Vec<CompiledAttribute>,
}

#[derive(Clone, Copy)]
pub(in crate::declarations) struct Array<'compilation, 'arena> {
...
pub(crate) fn collect<'source, 'arena>(
    heap: &Heap,
...
pub(crate) fn validate_alias_cycles(aliases: &AliasGraph) -> Result<(), CompileError> {

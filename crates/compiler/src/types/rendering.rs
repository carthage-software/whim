...
use crate::types::AliasExpansion;
use crate::types::GenericDecl;
use crate::types::GenericTable;
use crate::types::TypeScope;
use crate::types::lowering::is_wildcard;
...
pub(in crate::types) fn validate_composition(
    scope: &TypeScope<'_>,
    members: &[&Type<'_>],
    is_union: bool,
) -> Result<(), CompileError> {
...
pub(in crate::types) fn check_type_arguments(
...
pub(in crate::types) fn check_tuple_type(tuple: &TupleType<'_>) -> Result<(), CompileError> {
...
pub(in crate::types) fn flatten_union<'result, 'arena>(
...
pub(in crate::types) fn flatten_intersection<'result, 'arena>(
    source: &'result Type<'arena>,
) -> Vec<&'result Type<'arena>> {
    let mut members = Vec::new();
...
pub(crate) fn binder_arity(list: &TypeParameterList<'_>) -> (usize, usize) {
...
pub(in crate::types) fn check_arity(
...
pub(crate) fn check_type_argument_arity(
...
pub(crate) fn check_call_type_argument_arity(
    generics: &GenericTable<'_>,
    resolved: &str,
    arguments: Option<&TypeArgumentList<'_>>,
    span: Span,

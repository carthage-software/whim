...
use crate::operands::Access;
use crate::operands::Operand;
use crate::operands::implicit_reads;
use crate::operands::instruction_bytes;
use crate::operands::operands;
use crate::operands::register_at;
use crate::operands::write_may_alias_inputs;
use crate::passes::reuse_temporaries::OptimizationStatistics;
use crate::passes::reuse_temporaries::Reverse;
use crate::passes::reuse_temporaries::normalize_empty_window_starts;
use crate::passes::reuse_temporaries::pinned_high_water;
use crate::passes::reuse_temporaries::pinned_window_registers;
use crate::passes::reuse_temporaries::register_is_dead_after;
use crate::passes::reuse_temporaries::remap_registers;
use crate::passes::reuse_temporaries::successors;
...
fn replace_read_register(
    ...
    for operand in operands {
        if operand.access == Access::Read && register_at(bytes, operand.offset) == from {
            ...
            bytes[operand.offset].write(replacement[0]);
            bytes[operand.offset + 1].write(replacement[1]);
        }
    }

...
use crate::cfg::has_shared_switch_table;
use crate::cfg::successors;
use crate::liveness::register_is_dead_after_removals;
use crate::operands::for_each_read_register;
...
use crate::rewrite::destination::with_destination;
...
mod tests {
    ...
    use crate::OptimizationConfiguration;
    use crate::OptimizationStatistics;
    use crate::passes::move_coalescing::optimize_chunk;

...
use crate::passes::fuse_coalescing::normalized_chunk;
use crate::passes::inline_leaf_calls::CALLEE_INSTRUCTION_LIMIT;
use crate::passes::inline_leaf_calls::CALLER_CODE_LIMIT;
use crate::passes::inline_leaf_calls::InlineCandidates;
use crate::passes::inline_leaf_calls::OptimizationStatistics;
use crate::passes::inline_leaf_calls::REGISTER_LIMIT;
use crate::passes::inline_leaf_calls::Span;
use crate::passes::inline_leaf_calls::effect_on;
use crate::passes::inline_leaf_calls::jumping::build_jumping_replacement_capped;
use crate::passes::inline_leaf_calls::methods::method_body_inlinable;
use crate::passes::inline_leaf_calls::methods::unchecked_terminal;
use crate::passes::inline_leaf_calls::splice_replace_many;

...
use crate::passes::inline_leaf_calls::generic::generic_call_sites;
use crate::passes::inline_leaf_calls::generic::inline_generic_statics;
use crate::passes::inline_leaf_calls::generic::splice_generic_sites;
use crate::passes::inline_leaf_calls::jumping::self_inline_function;
use crate::passes::inline_leaf_calls::leaf::LeafCallee;
use crate::passes::inline_leaf_calls::leaf::inline_into_chunk;
use crate::passes::inline_leaf_calls::leaf::leaf_callee;
use crate::passes::inline_leaf_calls::methods::inline_direct_methods;
use crate::rewrite::splice::splice_replace;
use crate::rewrite::splice::splice_replace_many;
...
/// pipeline afterwards.
pub(crate) struct InlineChanges {
    pub(crate) main: bool,
    pub(crate) functions: Vec<usize>,
    pub(crate) methods: Vec<(usize, usize)>,
}

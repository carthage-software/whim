...
use crate::passes::fuse_coalescing::normalize_chunk;
use crate::passes::fuse_coalescing::normalized_chunk;
use crate::passes::inline_leaf_calls::CALLEE_INSTRUCTION_LIMIT;
use crate::passes::inline_leaf_calls::Location;
use crate::passes::inline_leaf_calls::MethodSite;
use crate::passes::inline_leaf_calls::OptimizationStatistics;
use crate::passes::inline_leaf_calls::TypeFlow;
use crate::passes::inline_leaf_calls::effect_on;
use crate::passes::inline_leaf_calls::jumping::body_jump_targets_are_forward;
use crate::passes::inline_leaf_calls::jumping::build_jumping_replacement;
use crate::passes::inline_leaf_calls::leaf::owned_register_mask;
use crate::passes::inline_leaf_calls::leaf::straight_line_body_instruction;

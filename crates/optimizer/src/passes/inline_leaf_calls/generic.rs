...
use crate::passes::inline_leaf_calls::jumping::build_jumping_replacement_bound;
...
pub(crate) fn generic_call_sites(
    chunk: &Chunk,
...
pub(crate) fn splice_generic_sites(
    chunk: &mut Chunk,
    functions: &[CompiledFunction],
    sites: &[(usize, usize)],
    register_cap: u16,
...
pub(crate) fn inline_generic_statics(

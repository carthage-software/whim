...
pub(crate) fn descriptor_mask(descriptor: &TypeDescriptor) -> Option<u16> {
    match descriptor {
...
pub(in crate::type_flow) fn exact_descriptor_mask(descriptor: &TypeDescriptor) -> Option<u16> {
    match descriptor {
...
pub(in crate::type_flow) fn descriptor_may_release_observably(descriptor: &TypeDescriptor) -> bool {
    match descriptor {
...
pub(crate) fn descriptors_disjoint(
    left: &TypeDescriptor,
...
pub fn descriptors_equal(left: &TypeDescriptor, right: &TypeDescriptor, depth: usize) -> bool {
    if depth > MAX_TYPE_DEPTH {
        return false;
    }
    match (left, right) {
...
pub(crate) fn descriptor_slices_equal(
    left: &[TypeDescriptor],
    right: &[TypeDescriptor],
    depth: usize,
) -> bool {
...
pub(crate) fn literal_descriptor_matches(literal: &Literal, expected: &TypeDescriptor) -> bool {
...
pub(crate) fn literal_descriptor_disjoint(literal: &Literal, excluded: &TypeDescriptor) -> bool {

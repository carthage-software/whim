...
use crate::type_flow::descriptors::descriptor_may_release_observably;
use crate::type_flow::transfer::numeric_result;
use crate::type_flow::transfer::transfer;
...
pub(crate) use world::IndexedUnit;
pub use world::World;
...
pub(crate) struct TypeFlowOptions<'a> {
    pub(crate) has_receiver: bool,
    pub(crate) class_name: Option<&'a Atom>,
    pub(crate) class_type_parameters: &'a [CompiledTypeParameter],
    pub(crate) track_array_elements: bool,
    pub(crate) cache_constants: bool,
    pub(crate) capture_types: Vec<Option<TypeDescriptor>>,
}
...
impl<'a> TypeFlow<'a> {
    ...
    pub(crate) fn chunk(&self) -> &'a Chunk {
        self.chunk
    }

    pub(crate) fn nullness(&self, index: usize, register: Register) -> Option<bool> {
    ...
    pub(crate) fn capture_types(&self) -> &[Option<TypeDescriptor>] {
        &self.capture_types
    }
    ...
    pub(crate) fn analyze_with_unit(
        chunk: &'a Chunk,
        parameters: &'a [CompiledParameter],
        has_receiver: bool,
        class_name: Option<&'a Atom>,
    ...
    pub(crate) fn analyze_with_unit_options(
        chunk: &'a Chunk,
        parameters: &'a [CompiledParameter],
        unit: &'a IndexedUnit<'a>,
        allocator: &'a Heap,
    ...
    pub(crate) fn analyze_live_with_unit(
        chunk: &'a Chunk,
        registers: &[Value],
        unit: &'a IndexedUnit<'a>,
        allocator: &'a Heap,
    ...
    pub(crate) fn register_may_release_observably(&self, index: usize, register: Register) -> bool {

...
use crate::type_flow::ALWAYS_REFERENCE_COUNTED;
...
impl TypeFlow<'_> {
    ...
    pub(crate) fn method_arguments_proven(&self, index: usize, first: usize, count: usize) -> bool {
    ...
    pub(crate) fn function_arguments_proven(
        &self,
        index: usize,
        first: usize,
        count: usize,
    ...
    pub(crate) fn callee_arguments_proven(
        &self,
        index: usize,
        first: usize,
        count: usize,
    ...
    pub(crate) fn proves_constructed_array(
        &self,
        index: usize,
        register: Register,
        expected: &TypeDescriptor,
    ...
    pub(crate) fn proves_reference_counted(&self, index: usize, register: Register) -> bool {
        if index >= self.chunk.code.len() || !self.reachable[index] {
            return false;
        }
        let register = usize::from(register.index());
    ...
    pub(crate) fn proves_scalar(&self, index: usize, register: Register) -> bool {
        if index >= self.chunk.code.len() || !self.reachable[index] {
            return false;
        }
        let register = usize::from(register.index());
    ...
    pub(in crate::type_flow) fn fact_proves(
        &self,
        fact: Fact,
        expected: &TypeDescriptor,
        depth: usize,
    ...
    pub(in crate::type_flow) fn dictionary_proves(
        &self,
        fact: Fact,
    ...
    pub(in crate::type_flow) fn dictionary_side_proves(
        &self,
        fact: Fact,
        expected: &TypeDescriptor,
        offset: usize,
    ...
    pub(in crate::type_flow) fn tuple_proves(
        &self,
        fact: Fact,
    ...
    pub(in crate::type_flow) fn literal_matches(
        &self,
        fact: Fact,
        expected: &TypeDescriptor,
    ) -> bool {
    ...
    pub(in crate::type_flow) fn new_static_proves(
        &self,
        fact: Fact,
        expected: &TypeDescriptor,
        depth: usize,
    ...
    pub(crate) fn nominal_named_proves(
        &self,
        actual_name: &Atom,

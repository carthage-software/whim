...
use crate::passes::inline_leaf_calls::InlineChanges;
use crate::passes::specialize_comparison;
...
pub use callable::optimize_function as optimize_callable_function;
pub use callable::optimize_method as optimize_callable_method;
pub use live::Refinement as LiveRefinement;
pub use live::refine as refine_live_chunk;
pub use type_flow::World;
pub use type_flow::WorldCache;
pub use type_flow::descriptors_equal;

pub fn descriptor_proves(actual: &TypeDescriptor, expected: &TypeDescriptor, depth: usize) -> bool {
    type_flow::descriptor_proves(actual, expected, None, depth)
}

...
use crate::passes::fuse_coalescing;
use crate::passes::inline_leaf_calls::leaf::inline_live_tail;
use crate::passes::optimize_isolated_live_tail;
use crate::passes::specialize_arithmetic;
use crate::passes::specialize_arrays;
...
pub fn refine(refinement: Refinement<'_>) -> Option<Chunk> {
    let Refinement {
        chunk,
        unit,
        registers,
